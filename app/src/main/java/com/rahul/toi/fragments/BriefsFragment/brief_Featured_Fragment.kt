...
import kotlinx.android.synthetic.main.fragment_brief__featured_.*
 ...
 * Use the [brief_Featured_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class brief_Featured_Fragment : Fragment(), NewsClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_brief__featured_, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment brief_Featured_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            brief_Featured_Fragment().apply {
                ...
                override fun onResponse(
                    ...
                    if (response.body() != null) {
                        ...
                        val adapter = PoliticsViewAdapter(
                            ...
                            this@brief_Featured_Fragment
                        )
                        val linearLayoutManager = LinearLayoutManager(context)
                        FeatureRV.layoutManager = linearLayoutManager
                        FeatureRV.adapter = adapter
                        FeaturePB.visibility = View.GONE
                    }
                }
