...
import kotlinx.android.synthetic.main.fragment_city__delhi_.*
 ...
 * Use the [city_Delhi_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class city_Delhi_Fragment : Fragment(), NewsClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_city__delhi_, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment city_Delhi_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            city_Delhi_Fragment().apply {
                ...
                override fun onResponse(
                    ...
                    if (response.body() != null) {
                        ...
                        val adapter = PoliticsViewAdapter(
                            ...
                            this@city_Delhi_Fragment
                        )
                        val linearLayoutManager = LinearLayoutManager(context)
                        delhiRV.layoutManager = linearLayoutManager
                        delhiRV.adapter = adapter
                        DelhiPB.visibility = View.GONE
                    }
                }
