...
import kotlinx.android.synthetic.main.fragment_brief_sports_.*
 ...
 * Use the [brief_sports_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class brief_sports_Fragment : Fragment(), NewsClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_brief_sports_, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment brief_sports_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            brief_sports_Fragment().apply {
                    ...
                    if (response.body() != null) {
                        ...
                        val adapter =
                            SportsViewAdapter(
                                ...
                                this@brief_sports_Fragment
                            )
                        val linearLayoutManager = LinearLayoutManager(context)
                        SportsFragRV.layoutManager = linearLayoutManager
                        SportsFragRV.adapter = adapter
                        SportsFragPB.visibility = View.GONE
                    }
                }
